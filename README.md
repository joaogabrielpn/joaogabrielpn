<div align="center">
  ...
  <a href="https://github.com/joaogabrielpn">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&duration=3000&pause=1000&color=44BBA4&center=true&vCenter=true&width=500&lines=Olá%2C+eu+sou+o+João+Gabriel!;Desenvolvedor+Back-end;Graduando+em+Ciência+da+C." alt="Typing SVG" />
  </a>

  <p align="center">
    🎓 <b>Ciência da Computação</b> na Universidade Federal do Agreste de Pernambuco (UFAPE)
  </p>
...
<table align="center" width="100%">
  <tr>
    ...
    <td width="55%" valign="top">
      ...
      <p>Sou um estudante de Ciência da Computação apaixonado por arquitetura de software e soluções robustas de Back-end.</p>
      <ul>
        <li>🔭 Atualmente focado em criar APIs eficientes e seguras.</li>
        <li>🌱 Estudando estruturas de dados, algoritmos e boas práticas de desenvolvimento.</li>
        <li>💬 Fale comigo sobre: <b>Java, Python, arquitetura e computação</b>.</li>
        <li>📫 Como me encontrar: <a href="mailto:joaogabrielpn01@gmail.com">joaogabrielpn01@gmail.com</a></li>
      </ul>
    </td>
    <!-- Coluna da direita: Minha Stack (Skill Icons) -->
    <td width="45%" valign="top" align="center">
      <h3>🛠️ Minhas Stacks</h3>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=java,py,js,html,css,git,github,vscode&perline=4" alt="Minhas Tecnologias" />
      </a>
    </td>
  </tr>
</table>
